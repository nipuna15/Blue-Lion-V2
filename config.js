const fs = require('fs-extra') 
 ...
 //═══════[Required Variables]════════\\ 
 global.owner = process.env.OWNER_NUMBER.split("94715442757") 
 ...
 global.sudo = process.env.SUDO || '94715442757' 
 global.devs = '94715442757'; 
 ...
 module.exports = { 
   botname:   process.env.BOT_NAME === undefined ? 'lejendz md;ˢʰⁱᵏᵃ ᵗʰᵉʲᵃⁿ' : process.env.BOT_NAME, 
   ownername: process.env.OWNER_NAME === undefined ? 'shashika thejanⁿ' : process.env.OWNER_NAME,  
   author:  process.env.PACK_INFO.split(";")[0] === undefined ? 'shashika thejan' : process.env.PACK_INFO.split(";")[0], 
